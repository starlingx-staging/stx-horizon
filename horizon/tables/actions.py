...
class BaseAction(html.HTMLElement):
    ...
    def __init__(self, **kwargs):
        ...
        self.confirm_message = kwargs.get('confirm_message', None)
        self.confirm_class = kwargs.get('confirm_class', None)
    ...
    def get_confirm_message(self, request, datum):
        ...
        Returns a confirmation message when performing this action against
        this table.

        By default, this returns self.confirm_message which default to None.
        When None is returned, the default confirmation message is used.
        """
        return self.confirm_message

    def get_confirm_class(self, request, datum):
        """Returns a CSS class name to be used for the confirm action.

        By default, this returns self.confirm_class which defaults to None
        When None is returned, the default value if 'btn-primary'
        """
        return self.confirm_class
...
class LimitAction(BaseAction):
    ...
    limits = set(settings.TABLE_LIMITS)
    ...
    def get_limit_name(self, count):
        ...
        return force_text(self.limit_format % {'count': count,
...
class Deprecated(type):
    ...
    def __new__(meta, name, bases, kwargs):
        ...
        # TODO(tsmith) remove this change when murano implements a better way
        if name not in ['UpdateAction', 'UpdateName']:
            LOG.warning(
